...
if selected_province != "All":
    ...
    filtered_df = filtered_df[
        filtered_df["province"].astype(str)
        == selected_province
    ]
...
if selected_category != "All":
    ...
    filtered_df = filtered_df[
        filtered_df["product_category"].astype(str)
        == selected_category
    ]
...
if selected_segment != "All":
    ...
    filtered_df = filtered_df[
        filtered_df["customer_segment"].astype(str)
        == selected_segment
    ]
...
if not filtered_df[
    ...
    delivery_col1, delivery_col2, delivery_col3 = (
        st.columns(3)
    )
